    ...
    (function () {
        function whenLoaded() {
            ...
            xmlhttp.onload = function () {
                ...
                var dropdownData = JSON.parse(JSON.stringify(jsonGETResponse));

                const dropdownList = document.getElementById("dropdownList");
                //<li class="mdl-menu__item" data-val="boat type string">boat type string</li>> 
                for (var i = 0; i < dropdownData.length; i++) {
                    var e = document.createElement("li");
                    e.setAttribute("class", "mdl-menu__item");
                    e.setAttribute("data-val", dropdownData[i]["Name"]);
                    e.setAttribute("tabindex", "-1");
                    e.innerHTML = dropdownData[i]["Name"] + ", " + dropdownData[i]["Type"];
                    componentHandler.upgradeElement(e);
                    dropdownList.appendChild(e);
                    //dropdownData[i]["Email"]
                }
                getmdlSelect.init('#dropdown .getmdl-select');
            }
            xmlhttp.send();
        };
